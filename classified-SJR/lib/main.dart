...
class MyApp extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      title: 'Flutter Tflite Integration Demo',
      home: MyHome(),
    );
  }
}
...
class _MyHomeState extends State<MyHome>{
  ...
  dynamic runModel(String msg) async {
    //create interpreter for you model
    final interpreter = await tfl.Interpreter.fromAsset('assets/logistic_regression_model.tflite');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Flutter Tflite Demo'),),
      body: Center(
        child: Column(
          children: [
            TextField(controller: controller,),
            TextButton(onPressed: ()=> res = runModel(controller.text), child: const Text("Click to predict")),
            Text('$res'),
          ],
        ),
      ),
